...
export default function BasicTable({
  ...
  return (<div  className={`border-t ${className}`}><Styles style={{height: "100%"}}>
            <div
        {...getTableProps()}
    ...
    <div className="mt-4">
      ...
      */}
      <ul className="pagination flex-wrap">
        ...
        >
          <a className="page-link !text-purple-800 text-base !rounded-l-md">First</a>
        </li>
        <li
          className="page-item"
        ...
        <li
          ...
          disabled={!canNextPage}
        >
          <a className="page-link !text-purple-800 text-base rounded-r-md">Last</a>
        </li>
        <li>
